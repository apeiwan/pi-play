...
export function PopupMixin(options = {}) {
  return {
    ...
    methods: {
      ...
      addLock() {
        if (this.lockScroll) {
          this.bodyEl && disableBodyScroll(this.bodyEl);

          on(document, 'touchstart', this.touchStart);
          on(document, 'touchmove', this.onTouchMove);

          if (!context.lockCount) {
            document.body.classList.add('pi-overflow-hidden');
          }
          context.lockCount++;
        }
      },
      ...
      removeLock() {
        this.bodyEl && enableBodyScroll(this.bodyEl);
        if (this.lockScroll && context.lockCount) {
          ...
          if (!context.lockCount) {
            document.body.classList.remove('pi-overflow-hidden');
          }
        }
      },
